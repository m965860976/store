...
num7=(63+45+129+63+58+48+63)/(10+60+43+63+63+120+72+69+35+140+90+24+45+25+60+129+10+43+63+60+63+60+58+140+48+43+57+10+63+78)*100
num8=120/(10+60+43+63+63+120+72+69+35+140+90+24+45+25+60+129+10+43+63+60+63+60+58+140+48+43+57+10+63+78)*100
print("该月的总销售额为：",num1.__round__(2),"元")
print("该月平均每日销售数量为：",num2.__round__(2),"件")
print("该月羽绒服、牛仔裤、风衣、皮草、T恤、衬衫各种类月销售量占比分别为：",'\n',num3.__round__(2),"%",'\n',num4.__round__(2),"%",'\n',num5.__round__(2),"%",'\n',num6.__round__(2),"%",'\n',num7.__round__(2),"%",'\n',num8.__round__(2),"%")
print(type(num1))
print(type(num2))
print(type(num3))